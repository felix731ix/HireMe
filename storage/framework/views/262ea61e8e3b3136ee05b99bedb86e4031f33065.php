        ...
        <form action="/success" method="POST">
            ...
            <div class="payment-details">
                ...
                <?php for($i=0;$i<count($data);$i++): ?>
                    <?php
                        $sumTotal += $data[$i]->quantity * $data[$i]->products->price
                    ?>
                <?php endfor; ?>
            ...
            <div style="margin: 34px 0">
                ...
                <input id="cardNumber" name="card_number" style="text-align: left" type="text" class="input-field"
            ...
            <div class="row justify-content-between">
                <div class="col-4">
                    ...
                    <div class="row" style="align-items: center; text-align: center">
                        <div class="col"><input id="cardMonth" type="text" name="expiration_month"
                                                onchange="limit(this, this.value)" maxlength="2" class="input-field">
                        </div>
                        <span style="font-size: 2.4rem">/</span>
                        <div class="col"><input id="cardYear" name="expiration_year" type="text"
                                                onchange="limitYear(this, this.value)" maxlength="2"
                ...
                <div class="col-2" style="margin-right: 130px">
                    ...
                    <div class="row" style="align-items: center">
                        <div class="col"><input name="card_cvv" id="cardCVV" type="text" onchange="cvv(this, this.value)" maxlength="3"
                                                class="input-field"></div>
                    </div>
                </div>
            </div>
            <div style="margin: 24px 0">
                ...
                <?php endif; ?>
                    <button type="submit" class="btnPay" onclick="validateField()">Pay</button>
            </div>
        </form>
    </div>
</section>
...
<?php /**PATH D:\FILE TI\Semester 5\Web Programming\LS01\Tugas yang belum submit\HireMe\resources\views/payment/payment_cart.blade.php ENDPATH**/ ?>
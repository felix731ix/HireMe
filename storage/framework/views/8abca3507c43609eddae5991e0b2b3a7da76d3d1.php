...
<section>
    <div class="row m-0" style="padding: 88px 170px">
        <div class="col-3">
            <img src="<?php echo e(Storage::url($products_details->image)); ?>" width="100%" height="300px"
        ...
        <div class="col-3">
            <?php if(auth()->guard()->check()): ?>
                <?php if(auth()->user()->id != $products_details->user_id): ?>
                    <div style="padding: 20px 25px; box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.15);border-radius:8px">
                        <form action="/order-now/<?php echo e($products_details->id); ?>" action="GET">
                            <button type="submit" class="order-item">
                                Order Rp <?php echo number_format($products_details->price,0,',','.'); ?>
                            </button>
                        </form>
...
<?php /**PATH C:\xampp\htdocs\finalprojectreinert\HireMe\resources\views/marketpage/details_product_page.blade.php ENDPATH**/ ?>
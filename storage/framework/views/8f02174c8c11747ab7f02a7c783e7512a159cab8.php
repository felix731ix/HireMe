    ...
    <div class="main-body">
        ...
        <nav aria-label="breadcrumb" class="main-breadcrumb mt-4">
            <ol class="breadcrumb" style="background-color: transparent;">
                ...
                <li class="breadcrumb-item"><a href="/manageps" style="color: var(--primary_green_second); font-size:1.4rem;">Manage
                        Products & Services</a></li>
                <li class="breadcrumb-item active"
                    style="color: var(--primary_green); font-size:1.4rem; font-weight: var(--weight500)"
                    aria-current="page">Add New Item
                </li>
            </ol>
        </nav>
        <!-- /Breadcrumb -->
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <select class="form-control-custom" name="category_id">
                            <option value="">-Choose Category-</option>
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(old('category_id') == $category->id): ?>
                                    <option value="<?php echo e($category->id); ?>" name="category_id"
                                            selected><?php echo e($category->name); ?>

                                    </option>
                                <?php else: ?>
                                    <option value="<?php echo e($category->id); ?>"
                                            name="category_id"><?php echo e($category->name); ?></option>
                                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label" style="font-size: 14px">Image</label>
...
<?php /**PATH C:\xampp\htdocs\finalprojectreinert\HireMe\resources\views/seller_side/addnewitem.blade.php ENDPATH**/ ?>